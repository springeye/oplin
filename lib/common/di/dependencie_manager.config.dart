...
import '../../bloc/book_bloc.dart' as _i13;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.singletonAsync<_i10.TodosOverviewBloc>(() async => _i10.TodosOverviewBloc(
      todosRepository: await get.getAsync<_i8.TodoRepository>()));
  gh.singletonAsync<_i11.BookRepository>(
      () async => _i12.IsarBookRepository(await get.getAsync<_i5.Isar>()));
  gh.singletonAsync<_i13.BookBloc>(() async =>
      _i13.BookBloc(bookRepository: await get.getAsync<_i11.BookRepository>()));
  gh.singletonAsync<_i14.NoteBloc>(() async => _i14.NoteBloc(
      bookBloc: await get.getAsync<_i13.BookBloc>(),
      editLogic: get<_i4.EditNoteBloc>(),
      noteRepository: await get.getAsync<_i6.NoteRepository>()));
  gh.singletonAsync<_i15.SyncCubit>(() async => _i15.SyncCubit(
      await get.getAsync<_i6.NoteRepository>(),
      await get.getAsync<_i13.BookBloc>()));
  return get;
}
